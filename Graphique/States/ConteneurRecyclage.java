...
public class ConteneurRecyclage extends JPanel implements ActionListener{
	...
	public ConteneurRecyclage(Fenetre menu, Carte carte) {
		super();
		this.fenetre = menu;
	...
	public void propVoyage() {
		JLabel etiquette = new JLabel("Recyclage\n", SwingConstants.CENTER);
		etiquette.setFont(new Font("Serif",Font.BOLD,30));
		etiquette.setForeground(Color.white);
		add(etiquette);
		JLabel etiquette2 = new JLabel("Ajouter une des 3 dernières cartes de la fosse dans votre vie future :\n", SwingConstants.LEFT);
