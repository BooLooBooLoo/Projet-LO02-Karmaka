...
public class ConteneurRoulette extends JPanel implements ActionListener{
	...
	public ConteneurRoulette(Fenetre menu, Carte carte) {
		super();
		this.fenetre = menu;
	...
	public void propRoulette() {
		JLabel etiquette = new JLabel("Roulette\n", SwingConstants.CENTER);
